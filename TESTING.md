...
> Auto-generated by `release.sh` on 2026-07-19 for v0.16.2.
...
Version **0.16.2**, generated 2026-07-19.

| Metric | Count |
|--------|-------|
| Tests (including subtests) | 4677 |
| Top-level tests | 2879 |
| Passed | 2878 |
| Skipped | 1 |
| Failed | 0 |
| Packages | 34 |
| Benchmark functions | 155 |
| Aggregate coverage | 70.4% |
...
| `pkg/config` | 125 | 0 | 74.4% |
| `pkg/tenant` | 69 | 0 | 93.5% |
| `pkg/validation` | 58 | 0 | 88.7% |
| `pkg/cache` | 59 | 0 | 87.9% |
| `pkg/middleware` | 38 | 0 | 93.1% |
| `pkg/jsonic` | 182 | 0 | 91.7% |
| `pkg/graph` | 245 | 0 | 92.9% |
| `pkg/sulpher` | 316 | 1 | 79.7% |
| `pkg/oql` | 874 | 0 | 77.1% |
| `pkg/storage` | 448 | 0 | 74.8% |
| `pkg/timeseries` | 179 | 0 | 81.0% |
| `pkg/server` | 1370 | 0 | 77.2% |
