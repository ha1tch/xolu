...
> Auto-generated by `release.sh` on 2026-08-13 for v0.30.23.
...
Version **0.30.23**, generated 2026-08-13.

| Metric | Count |
|--------|-------|
| Tests (including subtests) | 5645 |
| Top-level tests | 3665 |
| Passed | 3664 |
| Skipped | 1 |
| Failed | 0 |
| Packages | 45 |
| Benchmark functions | 157 |
| Aggregate coverage | 70.2% |
...
| `pkg/oql` | 920 | 0 | 74.7% |
| `pkg/storage` | 493 | 0 | 76.8% |
| `pkg/timeseries` | 214 | 0 | 82.0% |
| `pkg/server` | 1712 | 0 | 75.0% |
| `pkg/tdigest` | 14 | 0 | 92.2% |
| `cmd/critrepro` | 0 | 0 | 0.0% |
| `cmd/iolu` | 20 | 0 | 27.9% |
| `cmd/tsbench` | 0 | 0 | 0.0% |
| `cmd/xolu` | 0 | 0 | 0.0% |
