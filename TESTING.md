...
> Auto-generated by `release.sh` on 2026-07-18 for v0.15.0.
...
Version **0.15.0**, generated 2026-07-18.

| Metric | Count |
|--------|-------|
| Tests (including subtests) | 4653 |
| Top-level tests | 2855 |
| Passed | 2841 |
| Skipped | 14 |
| Failed | 0 |
| Packages | 33 |
...
| `pkg/config` | 125 | 0 | 74.6% |
| `pkg/tenant` | 69 | 0 | 93.5% |
| `pkg/validation` | 58 | 0 | 89.3% |
| `pkg/cache` | 59 | 0 | 87.9% |
| `pkg/middleware` | 117 | 0 | 90.0% |
| `pkg/jsonic` | 182 | 0 | 91.7% |
| `pkg/graph` | 245 | 0 | 92.9% |
| `pkg/sulpher` | 316 | 1 | 79.7% |
| `pkg/oql` | 874 | 3 | 76.7% |
| `pkg/storage` | 448 | 5 | 74.7% |
| `pkg/timeseries` | 179 | 4 | 81.0% |
| `pkg/server` | 1364 | 0 | 77.2% |
