...
> Auto-generated by `release.sh` on 2026-08-04 for v0.26.0.
...
Version **0.26.0**, generated 2026-08-04.

| Metric | Count |
|--------|-------|
| Tests (including subtests) | 5456 |
| Top-level tests | 3556 |
| Passed | 3555 |
| Skipped | 1 |
| Failed | 0 |
| Packages | 44 |
| Benchmark functions | 157 |
| Aggregate coverage | 70.7% |
...
| `pkg/timeseries` | 209 | 0 | 81.2% |
| `pkg/server` | 1629 | 0 | 75.6% |
