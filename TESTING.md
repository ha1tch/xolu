...
> Auto-generated by `release.sh` on 2026-07-20 for v0.16.3.
...
Version **0.16.3**, generated 2026-07-20.

| Metric | Count |
|--------|-------|
| Tests (including subtests) | 4704 |
| Top-level tests | 2894 |
| Passed | 2880 |
| Skipped | 14 |
| Failed | 0 |
| Packages | 34 |
...
| `pkg/oql` | 874 | 3 | 76.7% |
| `pkg/storage` | 448 | 5 | 74.7% |
| `pkg/timeseries` | 194 | 4 | 81.0% |
| `pkg/server` | 1371 | 0 | 77.2% |
