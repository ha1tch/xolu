...
| T-40 | Data race in pkg/server shared state (detector-confirmed, unlocated) | server | P1 | ☐ | Trips every parallel graph e2e test under -race on multi-core. Stacks pending. |
